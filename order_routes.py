...
async def place_an_order(order:OrderModel, Authorize:AuthJWT=Depends()):
        ...
        return jsonable_encoder(repsonse)
...
async def list_all_orders(Authorize:AuthJWT=Depends()):
     """
          ## List all Orders
          This list all Orders made. It can be accessed by superusers
...
async def get_order_by_id(id:int, Authorize:AuthJWT=Depends()):
     """
          ...
          This gets and Order by its ID and is only accessed by a superuser
...
async def get_specific_order(id:int, Authorize:AuthJWT=Depends()):
     """
          ...
          This returns an order by ID for the currently loggin in user
     """
...
async def update_order_status(id:int,order:OrderStatusModel,Authorize:AuthJWT=Depends()):
     ...
     """
          ...
          This is for updating an order's status and requires ` order_status ` in str
     """
...
async def delete_an_order(id:int,Authorize:AuthJWT=Depends()):
     ...
     """
          ## Delete an Order
          This deletes an order by it's ID
     """
